...
namespace Owin.OAuthGeneric
{
	...
	public class OAuthCreatingTicketContext : BaseContext
	{
		...
		public OAuthCreatingTicketContext(
			...
			: this(ticket, context, options, backchannel, tokens, user: new ExpandoObject())
		{
		}
		...
		/// <see cref="dynamic"/> if it is not available.
		/// </summary>
		...
		/// </summary>
		public OAuthTokenResponse TokenResponse { get; private set; }
		...
		/// </summary>
		public ClaimsIdentity Identity { get { return  Ticket?.Identity; } }
	}
}